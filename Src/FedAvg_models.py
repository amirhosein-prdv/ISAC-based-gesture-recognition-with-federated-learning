...
class FedAvgAlgorithm:
    def __init__(self, model, n_gru_hidden_units, num_class, timestamp, train_loader):
        self.model = model
    ...
    def run(self, num_rounds, num_epochs):
        ...
        for round in range(num_rounds):
            ...
            for client, data_ in self.train_loader.items():
        ...
        torch.save(self.global_model.state_dict(), f'./results/FedAvg_model.pth')
        return round_accuracy_all, result
    


class FedAvgAlgorithm_SAM:
    def __init__(self, model, n_gru_hidden_units, num_class, timestamp, train_loader):
        self.model = model
        self.n_gru_hidden_units = n_gru_hidden_units
        self.num_class = num_class
    ...
    def train(self, model, device, train_loader, optimizer, criterion):
        ...
        for data, target in train_loader:
            ...
            criterion(model(data), target).backward()  # make sure to do a full forward pass
    ...
    def run(self, num_rounds, num_epochs):
        ...
        for round in range(num_rounds):
            ...
            for client_id in range(1, len(self.train_loader)+1):
                ...
                optimizer = SAM(local_model.parameters(), base_optimizer=base_optimizer)
        ...
        torch.save(self.global_model.state_dict(), f'./results/FedAvg_SAM_model.pth')
        return round_accuracy_all, result
    


class FedAvgAlgorithm_FGSM:
    def __init__(self, model, n_gru_hidden_units, num_class, timestamp, train_loader):
        self.model = model
        self.n_gru_hidden_units = n_gru_hidden_units
        self.num_class = num_class
    ...
    def run(self, num_rounds, num_epochs):
        ...
        torch.save(self.global_model.state_dict(), f'./results/FedAvg_FGSM_model.pth')
        return round_accuracy_all, result